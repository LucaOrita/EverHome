  ...
  return (
    <div className="flex flex-col h-full bg-bg-page">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto">
        {/* Urgent Header */}
        <div
          className="px-sp-6 pt-sp-4 pb-sp-6 flex flex-col items-center text-center bg-status-error"
        >
        ...
        {/* Person Section */}
        <div className="flex flex-col items-center px-sp-6 pt-sp-4 pb-sp-3">
          <div className="w-14 h-14 rounded-full bg-bg-page flex items-center justify-center">
            <User size={28} className="text-primary-medium" />
          </div>
          <h2 className="text-h1 text-primary-dark mt-sp-2">Margaret</h2>
        </div>

        {/* Action Buttons */}
        <div className="flex flex-col gap-sp-2 px-sp-6">
        ...
        {/* Timeline */}
        <div className="mt-sp-3 mx-sp-6 mb-sp-6">
